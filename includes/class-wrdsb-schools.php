...
class Main {
	 ...
	 *
	 * - Wrdsb_Schools_Loader. Orchestrates the hooks of the plugin.
	 * - Wrdsb_Schools_i18n. Defines internationalization functionality.
	 * - Wrdsb_Schools_Admin. Defines all hooks for the admin area.
	 * - Wrdsb_Schools_Public. Defines all hooks for the public side of the site.
	 *
